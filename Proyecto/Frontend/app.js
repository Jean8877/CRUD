...
//funciòn para visualizar datos en la tabla 
function visualizar (data){
    let tabla = ""; //innicializa la variable para almacenar el HTML de la tabla

    //Recorre cada elemento en el arrray "baul" y crea una fila de tabla
